...
public class TelescopicView : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //        if(!volume) {
        //            enabled = false;
        //            Debug.Log("Cant load Post Processing Volume");
        //            return;
        //        }
        //
        //        bool foundEffectSettings = volume.profile.TryGetSettings<Vignette>(out vignetteEffect);
        //        if(!foundEffectSettings) {
        //            enabled = false;
        //            Debug.Log("Cant load Vignette Effect settings");
        //            return;
        //        }
        //        
        //        vignetteEffect = ppv.GetComponent<Vignette>();
    }
